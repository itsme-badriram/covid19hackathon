...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC35zuevufB1F8oHJ-JwXJMHxc0k3fCbfE&libraries=geometry,places"
    ...
    <link rel="stylesheet" href="volDashboard.css">
...
<body>
    ...
    <div class="carousel">
        <div class="box show">
            <div class="volunteer">
                <h2>Report Migrant Labourers</h2>
                <p>Help them find a shelter and provide them food!</p>
                <div class="button"><a href="migrant">Report</a></div>
            </div>
            <span class="back-image migrant-image"></span>
        </div>
        <div class="box show">
            <div class="volunteer">
        ...
        <div class="box show">
            <div class="volunteer">
                ...
                <div class="button"><a href="geofencing">View Red-Zones</a></div>
            </div>
    ...
    <div class="main-first">
        <div class="box request">
            <div class="qr-vol">
                <span class="req-back qricon"></span>
                <h2 class="req-title">
                    <span class="head">Volunteer Pass</span>
                    <span class="icon pass"></span>
                </h2>
                <p><b>Volunteers</b> can get their working pass here. Each time when a volunteer accepts a job, unique <b>QR code</b> is generated and this QR code is valid only until the job is completed.</p><br>
                <div class="volPass" id="passgeneration">
                    <span>Your Pass has been generated!</span>
                </div><br>
                <button class="button"><a href="volPass">View Volunteer Pass</a></button><br>
            </div>
            <div class="vol-migrant" id="labourShelter">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                ...
                url:'generalUserAction.php?volPass=true',
                success: function(response){
                
                document.getElementById('passgeneration').innerHTML = '<span>'+ response +'</span>';
            },
        error: function(){
    ...
    if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            $.ajax({
                ...
                success: function(response){
                if(response == "")
            response = '<h3>Available Doctors near you (within 4 km)</h3><div class="avail-info"><span class="count">0</span><span>Normal Doctors</span></div><div class="avail-info"><span class="count red">0</span><span>Emergency Doctors</span></div><div class="no-result"><span>No Doctors Near Your Area</span> </div><div class="button"><a href="hosApp">Check Other Areas!</a></div>';
            ...
            $.ajax({
                ...
                url:"generalUserAction.php?labourShelter=true&lat="+pos['lat']+"&lng="+pos['lng'],
                success: function(response){
                if(response == "")
                response = '<h2 class="req-title doc-title lab-title"><span class="head">Nearest Labour Shelter</span><span class="icon migrant"></span></h2><div class="hosp-box"><div class="no-result"><span>No Labour Shelters Near Your Area</span></div> </div><div class="button"><a href="migrantMapDisplay">Check Other Areas!</a></div> '
                document.getElementById('labourShelter').innerHTML = response;
            },error: function(){
...
function downloadUrl(url, callback) {
      ...
      function doNothing() {}
                        ...
                        function onNearestMigrant(){
                            window.location = 'migrantMapDisplay';
                        }
